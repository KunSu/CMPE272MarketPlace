...
<body class="homepage">
   ...
   ================================================== -->
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/kunsu/God Of War.php">
                                <img src="images/kunsu/God Of War.jpg" alt="God Of War">
    ...
    <section id="portfolio">
        <div class="row section-head">
            <div class="twelve columns about">
                <h1>Top 10 drinks<span>.</span></h1>
                <p>Below is the list of Top 10 drinks.</p>
                <br>
            </div>
        </div>
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/lijuan/hong kong style milk tea.php">
                                ...
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                                        <h5>hong kong style milk tea</h5>
                                        <p>No.5</p>
                                    </div>
                                </div>
                            </a>
    ...
    <section id="portfolio">
        <div class="row section-head">
            <div class="twelve columns about">
                <h1>Top 10 IT services used by consumers<span>.</span></h1>
                <p>Below is the list of Top 10 IT services used by consumers.</p>
                <br>
            </div>
        </div>
        ...
        <div class="row items">
            <div class="twelve columns">
                ...
                <div id="portfolio-wrapper" class="bgrid-fourth s-bgrid-third mob-bgrid-half group">
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/Mario Kart 8 Deluxe.php">
                                <img src="images/ruzhang/Mario Kart 8 Deluxe.png" alt="Mario Kart 8 Deluxe">
                                <div class="overlay"></div>
                                <div class="portfolio-item-meta">
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/Super Smash Bros Ultimate.php">
                                <img src="images/ruzhang/Super Smash Bros Ultimate.png" alt="Super Smash Bros. Ultimate">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                    ...
                    <div class="bgrid stack item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/Super Mario Odyssey.php">
                                <img src="images/ruzhang/Super Mario Odyssey.png" alt="Super Mario Odyssey">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/The Legend of Zelda BOTW.php">
                                <img src="images/ruzhang/The Legend of Zelda BOTW.png" alt="The Legend of Zelda BOTW">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                                        <h5>The Legend of Zelda: BOTW</h5>
                                        <p>No.4</p>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/Pokemon Lets Go Pikachu.php">
                                <img src="images/ruzhang/Pokemon Lets Go Pikachu.png" alt="Pokemon Lets Go Pikachu">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                                        <h5>Pokemon Let's Go Pikachu</h5>
                                        <p>No.5</p>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/Splatoon 2.php">
                                <img src="images/ruzhang/Splatoon 2.png" alt="Splatoon 2">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                                        <h5>Splatoon 2</h5>
                                        <p>No.6</p>
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/Super Mario Party.php">
                                <img src="images/ruzhang/Super Mario Party.png" alt="webDevelopment">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                                        <h5>Super Mario Party</h5>
                                        <p>No.7</p>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/New super Mario Bros U Deluxe.php">
                                <img src="images/ruzhang/New super Mario Bros U Deluxe.png" alt="New super Mario Bros. U Deluxe">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/Super Mario Maker 2.php">
                                <img src="images/ruzhang/Super Mario Maker 2.png" alt="Super Mario Maker 2">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
                                        <h5>Super Mario Maker 2</h5>
                                        <p>No.9</p>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="bgrid item">
                        <div class="item-wrap">
                            <a href="companies/ruzhang/The Legend of Zelda Links Awakening.php">
                                <img src="images/ruzhang/The Legend of Zelda Links Awakening.png" alt="The Legend of Zelda: Link's Awakening">
                                <div class="overlay">
                                    <div class="portfolio-item-meta">
            ...
            <div class="twelve columns">
                ...
                <div class="service-list bgrid-third s-bgrid-half mob-bgrid-whole">
                    ...
                    <div class="bgrid">
                        ...
                        <div class="service-content">
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                laudantium, totam rem aperiam, eaque ipsa quae ab illo inventoveritatis et quasi
                                architecto beatae vitae dicta sunt explicabo.
                            </p>
                        </div>
                ...
                <div id="blog-wrapper" class="bgrid-third s-bgrid-half mob-bgrid-whole group">
                    ...
                    <article class="bgrid">
                        ...
                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor,
                            isi elit consequat ipsum, nec sagittis sem nibh id elit. Sed ut perspiciatis unde omnis iste
                    ...
                    <article class="bgrid">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum fuga distinctio natus ab
                            sint
                            voluptate quos cumque assumenda ipsa cupiditate aperiam officiis recusandae nemo labore
                            adipisci harum,
                            ea odio dolor.
                        </p>
                    ...
                    <article class="bgrid">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt cumque, aut nam at,
                            doloremque repellat blanditiis quo accusantium, rerum dignissimos alias eligendi, laudantium
                            quod.
    ...
    <section id="contact">
        ...
        <div class="row section-head">
            ...
            <div class="twelve columns">
				...
				echo "Send me an email if you are interest for my resume."
			 ?>
                <hr />
